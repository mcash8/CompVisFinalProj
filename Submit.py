...
def test(args):
    ...
    for i_img in range(i_imgs):
        msg = 'denoising img number %d' % i_img
        print(msg)
        for i_block in range(i_blocks):
            msg = 'denoising block number %d' % i_block
            print(msg)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--noise_dir','-n', default='testsets/sidd_small/ValidationNoisyBlocksSrgb.mat', help='path to noise image file')
    ...
    del mat['ValidationNoisyBlocksSrgb']
