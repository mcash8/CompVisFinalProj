...
switch Method
    case 'gamma'
        SIDD_Denoise(@GammaCorrect, SiddDataDir, 'srgb', OptionalData);
    case 'clahe'
        SIDD_Denoise(@CLAHECorrect, SiddDataDir, 'srgb', OptionalData);
    case 'histogramequalization'
        SIDD_Denoise(@HECorrect, SiddDataDir, 'srgb', OptionalData);
    case 'CBM3D'
        print('in progress')
